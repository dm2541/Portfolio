...
<body>
	<div class="top-column column">
			...
			<div class="header clearfix">
				<div class="wrapper">
					<a href="/index"><h1>MACHOMANZ STORE</h1></a>
				</div>
   				<div class="userMenu-wrapper toggleBox">
	        		<ul class="userMenu-list-notLogin userMenu-list clearfix">
			    		<li class="listItem loginBtn"><a href="login.jsp">로그인</a></li>            			
            			<li class="listItem"><a href="signUp.jsp" title="회원가입"><span>회원가입</span></a></li>
		...
		<div class="right_area">
			<div class="division_box hover_box box_division_group">
				...
				<dl class="list_division_brand">
					...
					<dd>
						<ul class="division_reset" onclick="">
