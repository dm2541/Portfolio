...
public class LoginCustomerDAO {
	...
	public CustomerBean nameSearch(String cust_id, String cust_pw){
		String sql = "select cust_id, cust_pw, cust_name, cust_addr, cust_tel from customer where cust_id=? and cust_pw=?";
